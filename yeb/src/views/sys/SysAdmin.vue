...
<template>
  <div>
      <div style="display: flex;justify-content: center;margin-top: 10px">
        <el-input placeholder="通过用户名搜索用户..." prefix-icon="el-icon-search" v-model="keyWorks"
        ...
        <el-card class="admin-card" v-for="(admin, index) in admins" :key="index">
            <div slot="header" class="clearfix">
              ...
              <el-button style="float: right;padding: 3px 0;color:red" type="text" 
                  icon="el-icon-delete" @click="deleteAdmin(admin)">删除</el-button>
            </div>
            <div>
...
<script>
    export default {
          ...
          methods: {
              ...
              initAdmins(){
                this.getRequest('/system/admin/?keyWorks='+ this.keyWorks).then(resp => {
                  if(resp){
                    this.admins = resp;
                  }
                });
              ...
              deleteAdmin(data){
                  this.$confirm("此操作将永久删除该[" + data.name + "] 操作用户, 是否继续?","提示", {
