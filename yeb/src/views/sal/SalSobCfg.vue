...
<template>
    <div style="margin-top:10px">
          <el-table  :data="emps" stripe border size="mini" >
            ...
            <el-table-column prop="phone" label="电话号码" align="left"  width="120"></el-table-column>
            <el-table-column prop="department.name" label="所属部门" align="center" width="150"></el-table-column>
