...
<template>
  <div>
     <div style="display:flex;justify-content:space-between">
       ...
       <el-button type="success" icon="el-icon-refresh" @click="initSaries"></el-button>
     </div>
     <div style="margin-top:10px">
      <el-table :data="salaries" border stripe>
        ...
        <el-table-column label="基金" align="center">
     ...
     <el-dialog
          ...
          width="50%">
          <div style="display:flex;justify-context:space-around; align-items:center">
    ...
    export default {
          ...
          methods:{
            ...
            showEditSalaryView(data){
               ...
               this.trafficSalary = data.trafficSalary;
